  ...
  void updateUI(dynamic weatherData){
    setState(() {
      if(weatherData == null){
        temperature = 0;
        weatherIcon = 'ERROR!';
        weatherText = 'Unable to get data.';
        cityName = '';
        return;
      }
                ...
                children: <Widget>[
                  ...
                  TextButton(
                    onPressed: () async {
                      ...
                      if(typeName != null){
                        var weathertData = await weatherModel.getCityWeather(typeName);
                        updateUI(weathertData);
                      }
                    },
                    child: Icon(
                      Icons.location_city,
...
//var temp2 = decodeData['weather'][0]['id'];
//var temp3 = decodeData['name'];